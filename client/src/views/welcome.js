  ...
  const { loginWithRedirect } = useAuth0();
    return (
      <div className="welcome">
        ...
        <p><form action = {window.location.origin + "/" + document.getElementById.value}><label>Join!<input type="text" className="textbox" placeholder="Room Code" id="code" /></label></form></p>
