...
function Welcome(props) {
  ...
  return (
    <div className="welcome-container">
      ...
      <p><form action={"http://localhost:3000/" + document.getElementById.value}><label className="welcome-join">Join!<input type="text" class="textbox" placeholder="Room Code" id="code" /></label></form></p>
